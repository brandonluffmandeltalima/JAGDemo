...
import { Mail, Database, BarChart3, Send, AlertCircle, GitBranch, Users, FileText, Binary } from 'lucide-react';
  ...
  <div className="mvp-container">
    <div className="mvp-header">
      ...
      <div>
        ...
        <p className="mvp-subtitle">Paste an email to extract entities and relationships</p>
      </div>
    </div>
        ...
        <div className="email-draft-container">
          <div className="draft-header-fields">
            <div className="draft-field">
              ...
              <input type="text" className="draft-input" value="MAJ Sarah Johnson <sarah.johnson@jag.mil>" readOnly />
            </div>
            <div className="draft-field">
              <span className="draft-label">To:</span>
              <input type="text" className="draft-input" value="Legal Team <legal-team@jag.mil>" readOnly />
            </div>
            <div className="draft-field">
    ...
    {useRealAPI && processing && (
            <div className="pipeline-progress">
              <div className={`progress-step ${pipelineStep === 'classification' ? 'active' : pipelineStep && pipelineStep !== 'classification' ? 'complete' : ''}`}>
              ...
              <div className={`progress-step ${pipelineStep === 'ner' ? 'active' : (pipelineStep === 'graph' || pipelineStep === 'summary' || pipelineStep === 'complete') ? 'complete' : ''}`}>
                <div className="progress-icon">
                  <GitBranch />
                </div>
              ...
              <div className="progress-connector"></div>
              <div className={`progress-step ${pipelineStep === 'graph' ? 'active' : (pipelineStep === 'summary' || pipelineStep === 'complete') ? 'complete' : ''}`}>
                <div className="progress-icon">
                  <Database />
                </div>
                <span>Graph DB</span>
          ...
          {results.classification && (
            <div className="results-card classification-card">
              ...
              <div className="classification-result">
                <div className={`classification-badge ${results.classification.label === 'RELEVANT' || results.classification.label === 1 ? 'relevant' : 'irrelevant'}`}>
                  <AlertCircle size={20} />
                  <span>Classification: {results.classification.label === 1 || results.classification.label === 'RELEVANT' ? 'RELEVANT' : 'IRRELEVANT'}</span>
                </div>
                {results.classification.confidence !== undefined && (
                  <div className="classification-confidence">
                    <span className="confidence-label">Confidence:</span>
                    <div className="confidence-bar">
                      <div className="confidence-fill" style={{ width: `${results.classification.confidence * 100}%` }}></div>
                    </div>
